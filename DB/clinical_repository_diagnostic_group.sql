...
--
-- Table structure for table `diagnostic_group`
--

DROP TABLE IF EXISTS `diagnostic_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `diagnostic_group` (
  `diagnostic_group_id` mediumint(5) unsigned NOT NULL AUTO_INCREMENT,
  `group_name` char(100) DEFAULT NULL,
  `variable_prefix` char(8) DEFAULT NULL,
