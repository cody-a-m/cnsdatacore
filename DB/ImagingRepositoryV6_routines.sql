...
--
-- Temporary view structure for view `MAPP2SubReport`
--
...
/*!50001 CREATE VIEW `MAPP2SubReport` AS SELECT 
 1 AS `UploadID`,
 1 AS `UploadTime`,
 1 AS `StudyImageID`,
 1 AS `SiteID`,
...
--
-- Temporary view structure for view `QCSessionInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `QCSessionInfo` AS SELECT 
 1 AS `QCSessionID`,
 1 AS `QCDate`,
 1 AS `Finalized`,
 1 AS `DBSyncID`,
...
--
-- Temporary view structure for view `SubjectRolesCrossStudyInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `SubjectRolesCrossStudyInfo` AS SELECT 
 1 AS `StudyRoleID`,
 1 AS `StudyRoleName`,
 1 AS `StudySubjectID`,
 1 AS `SubjectName`,
...
--
-- Temporary view structure for view `SubjectRolesCrossStudyToQCAnswers`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `SubjectRolesCrossStudyToQCAnswers` AS SELECT 
 1 AS `StudyRoleID`,
 1 AS `StudyRoleName`,
 1 AS `StudySubjectID`,
 1 AS `SubjectName`,
...
--
-- Temporary view structure for view `StudyInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `StudyInfo` AS SELECT 
 1 AS `StudyID`,
 1 AS `StudyName`,
 1 AS `StudyNickName`,
 1 AS `NetworkID`,
...
--
-- Temporary view structure for view `LURNSubReport`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `LURNSubReport` AS SELECT 
 1 AS `UploadID`,
 1 AS `UploadTime`,
 1 AS `StudyImageID`,
 1 AS `SiteID`,
...
--
-- Temporary view structure for view `CrossProjectInfoToImages`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `CrossProjectInfoToImages` AS SELECT 
 1 AS `ProjectRowID`,
 1 AS `ProjectID`,
 1 AS `ProjectRowName`,
 1 AS `ProjectColumnID`,
 1 AS `ProjectColumnName`,
 1 AS `AssignmentID`,
 1 AS `StudyImageID`,
 1 AS `TimeStamp`,
 1 AS `QCSessionID`,
...
--
-- Temporary view structure for view `SubjectRolesCrossStudyToQCSessions`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `SubjectRolesCrossStudyToQCSessions` AS SELECT 
 1 AS `StudyRoleID`,
 1 AS `StudyRoleName`,
 1 AS `StudySubjectID`,
 1 AS `SubjectName`,
...
--
-- Temporary view structure for view `V4toV6SeriesUIDMatch`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `V4toV6SeriesUIDMatch` AS SELECT 
 1 AS `ImageScanID`,
 1 AS `StudyImageID`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `MAPP2Counts2`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `MAPP2Counts2` AS SELECT 
 1 AS `michigan_count`,
 1 AS `ucla_count`,
 1 AS `northwestern_count`,
 1 AS `washington_count`,
 1 AS `stlouis_count`,
 1 AS `iowa_count`,
 1 AS `total_count`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `ScanSessionInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `ScanSessionInfo` AS SELECT 
 1 AS `ScanSessionID`,
 1 AS `ScanDate`,
 1 AS `StudyUID`,
 1 AS `ProtocolID`,
...
--
-- Temporary view structure for view `QCSessionInfoImages`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `QCSessionInfoImages` AS SELECT 
 1 AS `QCSessionID`,
 1 AS `QCDate`,
 1 AS `FinalizedDate`,
 1 AS `StudyImageID`,
...
--
-- Temporary view structure for view `StudyRoleInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `StudyRoleInfo` AS SELECT 
 1 AS `StudyRoleID`,
 1 AS `StudyRoleName`,
 1 AS `StudyID`,
 1 AS `StudyName`,
...
--
-- Temporary view structure for view `MAPP2Report`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `MAPP2Report` AS SELECT 
 1 AS `UploadID`,
 1 AS `UploadTime`,
 1 AS `SiteID`,
 1 AS `Note`,
...
--
-- Temporary view structure for view `StudyImageInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `StudyImageInfo` AS SELECT 
 1 AS `StudyImageID`,
 1 AS `ImageID`,
 1 AS `SeriesUID`,
 1 AS `SequenceNumber`,
...
--
-- Temporary view structure for view `StudyPeopleInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `StudyPeopleInfo` AS SELECT 
 1 AS `StudyPeopleID`,
 1 AS `StudyID`,
 1 AS `PeopleID`,
 1 AS `PeopleRoleID`,
 ...
 1 AS `email`,
 1 AS `reason`,
 1 AS `archived_membership`,
 1 AS `standardized_membership`,
 1 AS `active_flag`,
 1 AS `ec_member`,
 1 AS `notes`,
 1 AS `date_added`,
...
--
-- Temporary view structure for view `CrossProjectInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `CrossProjectInfo` AS SELECT 
 1 AS `ProjectRowID`,
 1 AS `ProjectID`,
 1 AS `ProjectRowName`,
 1 AS `ProjectColumnID`,
...
--
-- Temporary view structure for view `MAPP2Counts`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `MAPP2Counts` AS SELECT 
 1 AS `scan_count`,
 1 AS `SiteID`,
 1 AS `site_nickname`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `BrainRegionInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `BrainRegionInfo` AS SELECT 
 1 AS `BrainRegionID`,
 1 AS `BrainRegionName`,
 1 AS `NativeID`,
 1 AS `ParentID`,
...
--
-- Temporary view structure for view `StudySubjectInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `StudySubjectInfo` AS SELECT 
 1 AS `StudySubjectID`,
 1 AS `SubjectName`,
 1 AS `StudyID`,
 1 AS `StudyName`,
...
--
-- Temporary view structure for view `ProjectStudyImageInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `ProjectStudyImageInfo` AS SELECT 
 1 AS `AssignmentID`,
 1 AS `ProjectRowID`,
 1 AS `ProjectColumnID`,
 1 AS `StudyImageID`,
...
--
-- Temporary view structure for view `LURNReport`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `LURNReport` AS SELECT 
 1 AS `UploadID`,
 1 AS `UploadTime`,
 1 AS `SiteID`,
 1 AS `Note`,
...
--
-- Temporary view structure for view `OverallQCInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `OverallQCInfo` AS SELECT 
 1 AS `QCAnswerID`,
 1 AS `QCSessionID`,
 1 AS `NumericData`,
 1 AS `TextData`,
...
--
-- Temporary view structure for view `QCAnswerInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `QCAnswerInfo` AS SELECT 
 1 AS `QCAnswerID`,
 1 AS `NumericData`,
 1 AS `TextData`,
 1 AS `Laterality`,
...
--
-- Temporary view structure for view `QCQuestionInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `QCQuestionInfo` AS SELECT 
 1 AS `QCQuestionID`,
 1 AS `QCQuestionName`,
 1 AS `ModalityID`,
 1 AS `QCQuestionDescription`,
...
--
-- Temporary view structure for view `SequenceInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `SequenceInfo` AS SELECT 
 1 AS `SequenceID`,
 1 AS `SequenceName`,
 1 AS `ModalityID`,
 1 AS `ModalityName`*/;
...
--
-- Temporary view structure for view `ImageInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `ImageInfo` AS SELECT 
 1 AS `ImageID`,
 1 AS `SeriesUID`,
 1 AS `SequenceNumber`,
 1 AS `ScanSessionID`,
...
--
-- Temporary view structure for view `SubjectInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `SubjectInfo` AS SELECT 
 1 AS `SubjectID`,
 1 AS `SiteID`,
 1 AS `SiteCode`,
 1 AS `SiteAcronym`,
...
--
-- Temporary view structure for view `QCAnswerInfoQCChoicesBrainRegions`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `QCAnswerInfoQCChoicesBrainRegions` AS SELECT 
 1 AS `QCAnswerID`,
 1 AS `QCSessionID`,
 1 AS `NumericData`,
 1 AS `TextData`,
...
--
-- Temporary view structure for view `QCChoiceInfo`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `QCChoiceInfo` AS SELECT 
 1 AS `QCChoiceID`,
 1 AS `QCChoiceOrder`,
 1 AS `QCChoiceName`,
 1 AS `AlertFlag`,
...
-- Dump completed on 2016-01-12 15:18:18
