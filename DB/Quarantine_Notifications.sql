...
CREATE TABLE `Notifications` (
  ...
  `NotificationTypeID` int(5) unsigned NOT NULL COMMENT '1:QuarantineAdditionProblem',
  `ViewedFlag` int(1) NOT NULL DEFAULT '0',
  `StudyUID` varchar(255) NOT NULL,
  `ViewToken` varchar(64) DEFAULT NULL,
  `StudyID` int(11) DEFAULT NULL,
  `ScanSessionID` int(11) DEFAULT NULL,
  PRIMARY KEY (`NotificationID`),
  UNIQUE KEY `uq-Notifications-Type-Upload-StudyUID` (`NotificationTypeID`,`StudyUID`),
  KEY `fk-Notifications-Contacts_idx` (`PeopleID`),
  KEY `fk-Notifications-NotificationTypes_idx` (`NotificationTypeID`)
