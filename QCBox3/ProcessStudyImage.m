function StudyImages = ProcessStudyImage(varargin)
...
for i = 1:length(StudyImageIDs)
    ...
    switch Modality{1,1}
        case 2
            ...
            StudyImages(i).Result = ProcessAnatomicalImage(Conn, Options, StudyImageIDs(i));
            QCAnatomicalImage(Conn, Options, StudyImageIDs(i));
        case 3
            if Options.verbose; disp([8 ' : Functional']); end;
            StudyImages(i).Result = ProcessFunctionalImage(Conn, Options, StudyImageIDs(i));
