...
--
-- Table structure for table `dataset_tmp`
--

DROP TABLE IF EXISTS `dataset_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dataset_tmp` (
  ...
  `pi_first_name` varchar(30) DEFAULT NULL,
  `pi_last_name` varchar(80) DEFAULT NULL,
  `acknowledgment` mediumtext,
  `methods` varchar(8) DEFAULT NULL,
  `authors` text,
  `funding` text,
