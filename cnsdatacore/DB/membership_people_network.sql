...
--
-- Table structure for table `people_network`
--

DROP TABLE IF EXISTS `people_network`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `people_network` (
  `people_network_id` int(7) unsigned NOT NULL AUTO_INCREMENT,
  `people_id` int(7) unsigned NOT NULL,
  `network_id` tinyint(2) unsigned NOT NULL,
  `active_flag` enum('active','inactive') DEFAULT 'active',
  `date_added` date DEFAULT NULL,
  `update_stamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`people_network_id`),
