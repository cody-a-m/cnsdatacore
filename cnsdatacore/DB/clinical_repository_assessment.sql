...
CREATE TABLE `assessment` (
  `assessment_id` smallint(3) unsigned NOT NULL AUTO_INCREMENT,
  `assessment_code` char(10) DEFAULT NULL,
  `assessment_version` char(50) DEFAULT NULL,
  `assessment_name` char(200) DEFAULT NULL,
