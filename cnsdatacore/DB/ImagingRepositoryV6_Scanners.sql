...
CREATE TABLE `Scanners` (
  `ScannerID` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `UIDRoot` varchar(255) NOT NULL,
  ...
  UNIQUE KEY `UIDRoot_UNIQUE` (`UIDRoot`)
) ENGINE=InnoDB AUTO_INCREMENT=58473 DEFAULT CHARSET=latin1;
