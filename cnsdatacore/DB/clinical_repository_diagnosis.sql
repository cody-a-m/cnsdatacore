...
CREATE TABLE `diagnosis` (
  `diagnosis_id` mediumint(5) unsigned NOT NULL AUTO_INCREMENT,
  `diagnosis_name` char(100) DEFAULT NULL,
  `diagnostic_group_id` smallint(4) unsigned DEFAULT NULL,
  `data_dictionary_id` int(7) unsigned DEFAULT NULL,
